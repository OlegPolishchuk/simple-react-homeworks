...
const HW15 = () => {
  ...
  const onChangePagination = (newPage: number, newCount: number) => {
    ...
    const {count, page, ...restQueries} = Object.fromEntries(searchParams)
    const allQueryParams = {...restQueries, ...pageQuery, ...countQuery}
    sendQuery(allQueryParams)
  ...
  const onChangeSort = (newSort: string) => {
    ...
    const {count, page, ...restQueries} = Object.fromEntries(searchParams)
    const allQueryParams = {count, page, ...restQueries}
    sendQuery(allQueryParams)
  }
